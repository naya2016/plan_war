...
var GameStart = function(){
	...
	/**************获取游戏图片并缓存*************/
	// 得到飞机图片
	this.plane_img = this.getImg('https://www.hualigs.cn/image/6069a9f2e0722.jpg');
	// 得到背景图片
	this.bg_img = [this.getImg('https://z3.ax1x.com/2021/04/04/cK2igU.jpg'),
		this.getImg('https://www.hualigs.cn/image/6069ab05e4168.jpg'),
		this.getImg('https://www.hualigs.cn/image/6069ab05f1197.jpg'),
		this.getImg('https://www.hualigs.cn/image/6069ab05f212f.jpg'),
		this.getImg('https://www.hualigs.cn/image/6069ab05ed803.jpg')];
	// 得到敌机图片
	this.enemy_img = [this.getImg('https://www.hualigs.cn/image/6069b20f1d6f1.jpg'),
		this.getImg('https://www.hualigs.cn/image/6069aad7c89fb.jpg'),
		this.getImg('https://www.hualigs.cn/image/6069aa21e8777.jpg')];
	// 得到我军子弹图片
	this.bullet_img1 = this.getImg('https://www.hualigs.cn/image/6069a94786a21.jpg');
	// 得到爆炸图片
	this.bomb_img = [this.getImg('https://z3.ax1x.com/2021/04/04/cK2P3T.gif'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cK2CCV.gif'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cK2p40.gif'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cK2SNq.gif'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKgzEn.gif'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKgvHs.gif'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKgjBj.gif'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKgXuQ.gif'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKgLjg.gif'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKgqgS.gif'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKgb38.gif')];
	// 得到HP图片
	this.HP_img4 = this.getImg('https://www.hualigs.cn/image/6069a9815aaf7.jpg');
	// 得到数字图片
	this.num_img = [this.getImg('https://z3.ax1x.com/2021/04/04/cKgRje.png'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKg2cD.png'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKgg1O.png'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKghBd.png'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKgfnH.png'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKg4HA.png'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKgIAI.png'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKgoNt.png'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKgT4P.png'),
		this.getImg('https://z3.ax1x.com/2021/04/04/cKgH9f.png')];
		
	/**************获取游戏音频并缓存*************/
	this.btToEp_audio = this.getAudio('https://uploader.shimo.im/f/kllTTfSoZoBo9U3k.mp3');//子弹打击敌机声音
